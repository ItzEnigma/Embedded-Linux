...
static char device_buffer[DEVICE_MAX_SIZE] = ""; 
/***********************************************************************************************/
...
static int __init mydriver_init(void)
{
    ...
    // 1 --> number of devices
    r_err = alloc_chrdev_region(&device_number, 0, 1, "mydeviceenigma");
    ...
    myclass = class_create("mydeviceenigma");

    // Create the device in /dev
    mydevice = device_create(myclass, NULL, device_number, NULL, "mydeviceenigma");
...
static void __exit mydriver_exit(void)
{
    ...
    printk(KERN_INFO "Removing mydeviceenigma ... bye bye ~ Enigma!\n");
}
