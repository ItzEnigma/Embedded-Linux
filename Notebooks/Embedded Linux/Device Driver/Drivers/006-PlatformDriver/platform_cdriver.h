 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *         FILE:  platform_cdriver.h
 *
 *  Description: This file contains the header files and the function prototypes for the platform_cdriver.c file.
 *
 *********************************************************************************************************************/

#ifndef _PLATFORM_CDRIVER_H
#define _PLATFORM_CDRIVER_H
